...
(function($) {
        ...
        // Make 'settings' variable global to validationEngine in order to call "loadValidation(caller,settings)"
        // directly from any javascript code, without second parameter ( ex.: loadValidation($(#inputId)); )
        $.validationEngine.initSettings=settings;
...
$.validationEngine = {
        ...
        loadValidation : function(caller,settings) {            // GET VALIDATIONS TO BE EXECUTED
            if (settings === undefined){
                $.validationEngine.settings = $.validationEngine.initSettings; // Here's the magic ! Wooo....
            } else {
